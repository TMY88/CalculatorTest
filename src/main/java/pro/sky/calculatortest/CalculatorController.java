...
public class CalculatorController {
    ...
    @GetMapping("/plus")
    public String adding(@RequestParam Integer num1, @RequestParam Integer num2) {
    ...
    @GetMapping("/multiply")
    public String miltipliction(@RequestParam Integer num1, @RequestParam Integer num2) {
